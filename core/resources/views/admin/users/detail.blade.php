        ...
        <div class="row mb-none-30">
                ...
                <div class="dashboard-w1 bg--info b-radius--10 box-shadow has--link">
                    ...
                    <div class="details">
                        <div class="numbers">
                            ...
                            <span class="amount">{{ showAmount($order['total_shopping']) }}</span>
                        </div>
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 mb-30">
                <div class="dashboard-w1 bg--success b-radius--10 box-shadow has--link">
                    <a href="{{ route('admin.orders.user',$user->id) }}" class="item--link"></a>
                    <div class="icon">
            ...
            <div class="col-xl-4 col-lg-4 col-sm-6 mb-30">
                <div class="dashboard-w1 bg--primary b-radius--10 box-shadow has--link">
                    <a href="{{ route('admin.orders.user.transactions',$user->id) }}" class="item--link"></a>
                    <div class="icon">
                        <i class="las la-list-ol"></i>
                    </div>
                    <div class="details">
                        <div class="numbers">
                            <span class="amount">{{ $order['total_transactions'] }}</span>
                        </div>
                        <div class="desciption">
                            <span>@lang('Transaction Logs')</span>
                        </div>
                    </div>
                </div>
            </div><!-- dashboard-w1 end -->
                    ...
                    <div class="row">
                        <div class="form-group col-xl-4 col-md-6  col-sm-3 col-12">
                            ...
                            <input type="checkbox" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle"
                                data-on="@lang('Active')" data-off="@lang('Banned')" data-width="100%" name="status" 
