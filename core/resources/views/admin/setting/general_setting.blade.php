                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold">@lang('Display Stock Quantity')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="display_stock" @if($general->display_stock) checked @endif>
                            </div>
                        </div>
                        <div class="row">
