...
@section('content')
<div class="dashboard-section pt-60 pb-60 bg-white">
    <div class="container">
        <div class="row">
                    ...
                    <div class="message__chatbox__body">
                        ...
                        <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form--group col-sm-12">
                                ...
                                <textarea id="message" name="message" id="inputMessage" class="form-control form--control"></textarea>
                            </div>
                            <div class="form--group col-sm-12">
                                <div class="d-flex">
                                    <div class="left-group col p-0">
                                        ...
                                        <span class="info fs--14">@lang('Allowed File Extensions'): .@lang('jpg'),
                                            .@lang('jpeg'), .@lang('png'), .@lang('pdf'), .@lang('doc'), .@lang('docx')</span>
                                    </div>
                                    <div class="add-area">
                                        <label class="form--label d-block">&nbsp;</label>
                                        <button type="button" class="cmn--btn btn--sm bg--base ms-2 ms-md-4 form--control addFile"><i class="las la-plus"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div id="fileUploadsContainer" class="mt-1"></div>
                                ...
                                <div class="reply-item">
                                    <div class="content-area">
                                        <span class="meta-date">
                                            @lang('Posted on') <span class="cl-theme">{{ $message->created_at->format('l, dS F Y @ H:i')
                                                }}</span>
                                        </span>
                                        <p>
                                            {{ $message->message }}
                ...
                $("#fileUploadsContainer").append(
                    `<div class="form--group col-sm-12">
                        <div class="input-group">
                            ...
                            <div class="add-area">
                                <button class="btn btn--danger ms-2 ms-md-4 form--control remove-btn" type="button">
                                    <i class="las la-times"></i>
                                </button>
                            </div>
                        </div>
